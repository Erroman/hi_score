...
xhi._makeTmpltFn_ = function ( aMap ) {
  ...
  // Purpose   : Set the module xhiJQ (jQuery) cache, $Map
  // Example   : set$Map( $top_box );
  // Arguments : (positional)
  //   0. $top_box - A xhiJQ (jQuery) object used to locate DOM elements.
  ...
  function initModuleFn ( $top_box ) {
    // Initialize DOM content and set xhiJQ (jQuery) collection cache
    set$Map( $top_box );
